...
public class TestTheftRisk {

    static TheftRisk theftRisk;
    ...
    static void init() {
        ...
        theftRisk = new TheftRisk(conditions);
    }
        ...
        return inData.stream()
                .map(val -> DynamicTest.dynamicTest("Calculate premium for different sum",
                        () -> {
                            ...
                            BigDecimal premium = theftRisk.calculate(policy);
    ...
    void calculatePremiumForMultipleObjects() {
        PolicySubObject pso11 = new PolicySubObject("subObj11", BigDecimal.valueOf(5.10), RiskType.THEFT);
        PolicySubObject pso12 = new PolicySubObject("subObj12", BigDecimal.valueOf(10.00), RiskType.THEFT);
        PolicySubObject pso21 = new PolicySubObject("subObj21", BigDecimal.valueOf(2.35), RiskType.THEFT);
        PolicySubObject pso22 = new PolicySubObject("subObj22", BigDecimal.valueOf(8.02), RiskType.THEFT);
